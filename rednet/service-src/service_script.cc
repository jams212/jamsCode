  ...
  public:
   ...
   private:
     int loadlua(const char *args, size_t sz)
     {
         ...
         assert(DEPLOY_H.luaService);

         lua_pushstring(L, DEPLOY_H.luaPath);
         lua_setglobal(L, "LUA_PATH");

         lua_pushstring(L, DEPLOY_H.luaCPath);
         lua_setglobal(L, "LUA_CPATH");

         lua_pushstring(L, DEPLOY_H.luaService);
